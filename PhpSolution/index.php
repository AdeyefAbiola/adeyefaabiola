<?php ob_start(); try { include './include/title.php'; include './include/random_image.php'; ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div id="wrapper">
    ...
    <main>
	  ...
	  <p>Ut enim ad minim veniam, quis nostrud exercitation consectetur adipisicing elit. Velit esse cillum dolore ullamco laboris nisi in reprehenderit in voluptate. Mollit anim id est laborum. Sunt in culpa duis aute irure dolor excepteur sint occaecat.</p>
		<?php if(isset($imageSize)){?>
		<figure><img src="<?php if(isset($selectedImage)){echo $selectedImage;} //<?=$selectedImage and close >?>" alt="Random Image" <?= $imageSize[3]; ?> class="picBorder"><figcaption><?= $caption; ?></figcaption></figure><?php } ?>
...
<?php } catch (Exception $e){
     ob_end_clean();
	header('Location: http://localhost/phpSolution/error.php');
} 
ob_end_flush();
?>